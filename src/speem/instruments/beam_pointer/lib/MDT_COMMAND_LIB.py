from ctypes import c_int, c_char_p, POINTER, c_double, cdll, create_string_buffer
...
def mdtOpen(serialNo:str, nBaud, timeout):
    """ Open MDT device
    Args:
