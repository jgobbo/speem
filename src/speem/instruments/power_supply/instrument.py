...
from daquiri_common.schema import ObjectType
...
class RudiEA2Driver:
    ...
    def __init__(self) -> None:
        ...
        for terminal, module in self.modules.items():
            self._terminal_voltages[terminal] = module.get_voltage()
    ...
    def terminal_voltages(self, terminal_voltages: dict[Terminal, float]) -> None:
